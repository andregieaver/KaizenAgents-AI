...
class AIAgentHubTester:
    def __init__(self, base_url="https://ai-automation-43.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if test_name == "rag":
            ...
            print("Available tests: rag, rag_enforcement, quota, mother_agent, new_features, security, channels, messaging, knowledge_base, phase2_credentials, phase3_scheduling")
            sys.exit(1)
    else:
        sys.exit(main())