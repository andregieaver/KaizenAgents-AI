...
Current user request: {user_prompt}"""
    ...
    async def create_run_log(self, conversation_id: str, user_prompt: str) -> str:
        ...
        run_doc = {
            ...
            "mother_admin_agent_id": self.mother_agent["id"] if self.mother_agent_type == "admin" else None,
            "mother_user_agent_id": self.mother_agent["id"] if self.mother_agent_type == "company" else None,
            "mother_agent_type": self.mother_agent_type,
